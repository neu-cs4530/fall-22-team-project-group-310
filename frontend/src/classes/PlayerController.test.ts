...
describe('PlayerController', () => {
  ...
  describe('Setting outgoingTeleport property', () => {
    it('updates the property and emits an outgoingTeleportChange event if the property changes', () => {
      expect(testPlayer.outgoingTeleport).toBeUndefined();
      ...
      testPlayer.outgoingTeleport = undefined;
      expect(testPlayer.outgoingTeleport).toBeUndefined();
      expect(mockListeners.outgoingTeleportChange).toHaveBeenCalledWith(undefined);
    });
